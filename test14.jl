...
_, bb2 = prepsig(x[:,2])
 ...
 events = Int[]
 events = find_mseq(bb2, (yb), 0.5, 2000) #0.7, 3000 for 4-2 #0.5, 3000 for 5-1 # 0.7, 2000 for 5-2 # 0.7,2000
 e_all = Float64[]
...
save("loc4.jld2", "cber1s", cber1s, "cber2s", cber2s, "cber3s", cber3s, "cber4s", cber4s)